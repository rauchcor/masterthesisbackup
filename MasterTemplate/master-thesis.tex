...
\begin{document}
  ...
  \include{acronyms}
	...
	\printbibliography[type=book,title={References - Books}]
	\printbibliography[type=article,title={References - Articles}]
	\printbibliography[type=online,title={References  - Online Sources}]
	\printbibliography[type=manual,title={References - Manuals}]
	\printbibliography[type=reports,title={References - Reports}]
	\printbibliography[type=misc,title={References - Miscellaneous}]
